  ...
  return (
    <div className="space-y-5">
      ...
      <div className="space-y-3">
        <h4 className="text-sm font-medium text-slate-600 border-b pb-1">收件資訊</h4>
        ...
        <F label="信件主旨 (選填)" value={coverLetter.subject} onChange={(v) => update('subject', v)} placeholder="e.g. Application for Software Engineer Position" />
      </div>
      ...
      <div className="space-y-3">
        ...
        <div>
          ...
          <textarea value={coverLetter.body} onChange={(e) => update('body', e.target.value)}
            placeholder="Throughout my career, I have developed..."
            spellCheck rows={6}
            className="w-full border border-slate-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/20 resize-none" />
        </div>
        <div>
