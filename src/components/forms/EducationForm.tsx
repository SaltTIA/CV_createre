          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <input value={edu.degree} onChange={(e) => dispatch({ type: 'UPDATE_EDUCATION', index: i, payload: { degree: e.target.value } })}
                placeholder="e.g. Bachelor's" className="w-full border border-slate-200 rounded px-2 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500" />
            </div>
            <div>
              ...
              <input value={edu.field} onChange={(e) => dispatch({ type: 'UPDATE_EDUCATION', index: i, payload: { field: e.target.value } })}
                placeholder="e.g. Computer Science" className="w-full border border-slate-200 rounded px-2 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500" />
            </div>
          </div>
          <div className="grid grid-cols-2 gap-3">
            <div>
